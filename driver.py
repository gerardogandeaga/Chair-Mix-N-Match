...
if __name__ == "__main__":
    ...
    models = Model.load_models([6012, 3453, 3336, 2234, 1392]) # you should be passing the output here into the mixer
    ...
    for i,model in enumerate(models):
        ...
        # SimpleObj.save("back-{}".format(i), parts["objs"]["legs"]) # this will save the back component of a chair
